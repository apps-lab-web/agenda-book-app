import{rc as a}from"./chunk-BGCY7CCZ.js";import{ba as o,fa as i,ya as s}from"./chunk-XH7EQUCG.js";var n=class r{constructor(e){this.iconService=e;this.registerCustomIcons(),this.isDark()&&this.applyDark(),this.syncElectronTheme(this.isDark())}DARK_THEME_ID="dark-theme-stylesheet";NZ_DARK_ID="nz-dark-stylesheet";STORAGE_KEY="agenda-book-theme";isDark=s(this.loadPreference());toggle(){this.isDark.update(t=>!t),this.isDark()?this.applyDark():this.removeDark();let e=this.isDark()?"dark":"light";localStorage.setItem(this.STORAGE_KEY,e),this.syncElectronTheme(this.isDark())}applyDark(){if(document.getElementById(this.DARK_THEME_ID))return;let e=document.createElement("link");e.id=this.NZ_DARK_ID,e.rel="stylesheet",e.href="nz-dark.css",document.head.appendChild(e);let t=document.createElement("link");t.id=this.DARK_THEME_ID,t.rel="stylesheet",t.href="dark-theme.css",document.head.appendChild(t),document.body.classList.add("is-dark")}removeDark(){document.getElementById(this.NZ_DARK_ID)?.remove(),document.getElementById(this.DARK_THEME_ID)?.remove(),document.body.classList.remove("is-dark")}loadPreference(){let e=localStorage.getItem(this.STORAGE_KEY);return e?e==="dark":window.matchMedia("(prefers-color-scheme: dark)").matches}syncElectronTheme(e){window.electronAPI?.setNativeTheme(e?"dark":"light")}registerCustomIcons(){this.iconService.addIconLiteral("theme:sun",`<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      </svg>`)}static \u0275fac=function(t){return new(t||r)(i(a))};static \u0275prov=o({token:r,factory:r.\u0275fac,providedIn:"root"})};export{n as a};
